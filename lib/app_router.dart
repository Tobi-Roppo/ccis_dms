...
import 'package:ccis_dms/views/screens/buttons_screen.dart';
import 'package:ccis_dms/views/screens/colors_screen.dart';
import 'package:ccis_dms/views/screens/crud_detail_screen.dart';
import 'package:ccis_dms/views/screens/crud_screen.dart';
import 'package:ccis_dms/views/screens/dashboard_screen.dart';
import 'package:ccis_dms/views/screens/dialogs_screen.dart';
import 'package:ccis_dms/views/screens/error_screen.dart';
import 'package:ccis_dms/views/screens/form_screen.dart';
import 'package:ccis_dms/views/screens/general_ui_screen.dart';
import 'package:ccis_dms/views/screens/login_screen.dart';
import 'package:ccis_dms/views/screens/logout_screen.dart';
import 'package:ccis_dms/views/screens/my_profile_screen.dart';
import 'package:ccis_dms/views/screens/register_screen.dart';
import 'package:ccis_dms/views/screens/task_details.dart';
import 'package:ccis_dms/views/screens/task_screen.dart';
import 'package:ccis_dms/views/screens/task_status_details.dart';
import 'package:ccis_dms/views/screens/text_screen.dart';
...
GoRouter appRouter(UserDataProvider userDataProvider) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: RouteUri.taskDetail,
        pageBuilder: (context, state) {
          return NoTransitionPage<void>(
            key: state.pageKey,
            child: TaskDetailScreen(id: state.queryParams['id'] ?? ''),
          );
        },
      ),
      GoRoute(
        path: RouteUri.taskStatus,
        pageBuilder: (context, state) {
          return NoTransitionPage<void>(
            key: state.pageKey,
            child: TaskStatusScreen(id: state.queryParams['id'] ?? ''),
          );
        },
      ),
    ],
