...
import 'package:ccis_dms/views/widgets/url_new_tab_launcher.dart';
                  ...
                  CardBody(
                    child: Column(
                      ...
                      children: [
                        ...
                        _typographyItem(
                            context, 'bodyText1', textTheme.bodyText1!, true),
                        _typographyItem(
                            context, 'bodyText2', textTheme.bodyText2!, true),
                        _typographyItem(
                            context, 'button', textTheme.button!, true),
                        _typographyItem(
                            context, 'caption', textTheme.caption!, true),
                        ...
                        _typographyItem(
                            context, 'headline1', textTheme.headline1!, true),
                        _typographyItem(
                            context, 'headline2', textTheme.headline2!, true),
                        _typographyItem(
                            context, 'headline3', textTheme.headline3!, true),
                        _typographyItem(
                            context, 'headline4', textTheme.headline4!, true),
                        _typographyItem(
                            context, 'headline5', textTheme.headline5!, true),
                        _typographyItem(
                            context, 'headline6', textTheme.headline6!, true),
                        ...
                        _typographyItem(
                            context, 'overline', textTheme.overline!, true),
                        _typographyItem(
                            context, 'subtitle1', textTheme.subtitle1!, true),
                        _typographyItem(
                            context, 'subtitle2', textTheme.subtitle2!, true),
                        _typographyItem(
                  ...
                  CardBody(
                    child: Column(
                      ...
                      children: [
                        ...
                        _googleFontItem(context, 'Gentium Basic',
                            GoogleFonts.gentiumBasic(), true),
