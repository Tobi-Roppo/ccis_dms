...
import 'package:ccis_dms/master_layout_config.dart';
import 'package:ccis_dms/providers/user_data_provider.dart';
import 'package:ccis_dms/theme/theme_extensions/app_sidebar_theme.dart';
  ...
  Widget _textButton(ThemeData themeData, AppSidebarTheme sidebarTheme,
    ...
    return TextButton(
      ...
      style: TextButton.styleFrom(
        backgroundColor: sidebarTheme.foregroundColor,
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
